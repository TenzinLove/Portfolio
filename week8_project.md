...
![OnMainPage](C:\Users\Math R\OneDrive\Bureau\Software\Photos\ViewAlert_MainPage.png)

Here, we can see the ViewAlert button which directs to the alerts page.

![AlertPage](C:\Users\Math R\OneDrive\Bureau\Software\Photos\AlertPage.png)

Here, it's the alert page with some alerts I created with the button "Create Alert"

![Filter](C:\Users\Math R\OneDrive\Bureau\Software\Photos\Filter.png)
